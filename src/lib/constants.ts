...
import { tokens } from './polygonTokenList.json';
...
export const POLYGON_TOKENS_EXTENDED = tokens as Token[];
...
export const POLYGON_TOKENS_BY_SYMBOL2: Record<string, Token> = {
  wmatic: {
    chainId: 137,
    name: 'Wrapped Matic',
    symbol: 'WMATIC',
